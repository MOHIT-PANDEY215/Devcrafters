...
const SignIn = () => {
    ...
    <div className="container w-full mx-auto mt-12 md:max-w-[574px] ">
        ...
        <header className="header py-0 px-3 mb-7 flex items-center justify-center">
            <h1 id="title" className="text-center bg-[#4e4e9bcc] text-white w-2/5 rounded-3xl font-normal text-xl">LOGIN</h1>
        </header>
        ...
        <form className="p-10 rounded-2xl bg-[#4e4e9bcc]" onSubmit={handleSubmit} >
            ...
            <div className="form-group mb-4">
                <label id="email-label" htmlFor="email" className="text-[#f0f8ff] text-xl ">User ID</label>
            ...
            <div className="form-group mb-4">
                <label className="text-[#f0f8ff] text-xl" htmlFor="password">Password</label>
            ...
            <div className="form-group">
                <button type="submit"  className="submit-button w-full cursor-pointer p-3 bg-[#37af65] hover:bg-[#37af25] rounded-[25px] mt-6 text-white text-xl">Login</button>
            </div>
